  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="card space-y-6" noValidate>
      <div className="grid gap-5 md:grid-cols-2">
        <div>
          <label className="block text-sm font-medium" htmlFor="idclient">
            ID client
          </label>
          <input
            id="idclient"
        ...
        <div>
          <label className="block text-sm font-medium" htmlFor="data">
            Data i hora
          </label>
          <input
            id="data"
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <div>
          <label className="block text-sm font-medium" htmlFor="num_persones">
            Nombre de persones
          </label>
          <input
            id="num_persones"
          ...
          />
          {errors.num_persones ? (
            <p className="mt-1 text-sm text-destructive">{errors.num_persones.message}</p>
          ) : null}
        </div>
