const sections = [
  {
    ...
    body: (
      <p className="text-stone-300">
        ...
        <strong> Pedido</strong>, <strong> Detall Pedido</strong> i <strong> Reserva</strong>,
  ...
  },
  {
    ...
    body: (
      <p className="text-stone-300">
        ...
        tenir múltiples reserves i múltiples pedidos; cada pedido es desglossa en línies a
  ...
  },
  {
    ...
    body: (
      <p className="text-stone-300">
        ...
        reserves i pedidos amb el seu detall. Cada formulari envia les dades als endpoints
  ...
  },
  {
    ...
    body: (
      <ul className="list-disc space-y-2 pl-5 text-stone-300">
        ...
        <li>
          <strong>Pedidos i detall:</strong> resumeix el total per comanda i permet aprofundir al
    ...
    body: (
      <div className="space-y-3 text-stone-300">
        ...
        >
          ...
          <span className="font-medium">Repositorio en GitHub</span>
        </a>
      </div>
    ),
  },
